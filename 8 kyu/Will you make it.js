...
write a function that tells you if it is possible to get to the pump or not. Function should return true (1 in Prolog)
...
const zeroFuel = (distanceToPump, mpg, fuelLeft) => {
    return fuelLeft - (distanceToPump / mpg) >= 0
};
